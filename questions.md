### Analise Exploratroria nos dados dos alunos do sul do Brasil no ano de 2023

O objeto `alunos_raw` é um dataframe que contém informações sobre alunos do Ensino Médio que realizaram a prova do Saeb em escolas do sul do Brasil no ano de 2023.

## Perguntas para análise dos dados

1. Qual a distribuição das escolas Urbanas e Rurais por estado?
